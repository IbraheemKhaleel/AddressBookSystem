...
public class AddressBookSystem {
	...
	public  void entryOptions()
	{
		...
		while (flag == 1)
		{
			System.out.println(" Select a choice : 1. Add 2.Edit  3. Delete "
								+ "4. Search 5. View person by city "
								+ " \n   		   6.count of persons with same city "
								+ "7. Sorting by name 8.Sorting by city 9. Writing to file 10. exit");
